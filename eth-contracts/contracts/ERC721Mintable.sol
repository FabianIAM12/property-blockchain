...
contract Ownable {
    ...
    modifier onlyOwner()
    {
        require(msg.sender == _owner, "Is called by another account, and not the owner");
        _;
    }
...
contract RealEstateToken is ERC721Metadata("LandXToken", "X12", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
